    ...
    >
      ...
      <div className="hidden md:flex gap-6 items-center">
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            <li className="hover:text-green-600 tooltip" data-tip="Cooming Soon">
              <a href="#" className="justify-between">
                প্রোফাইল
                <span className="badge">user</span>
              </a>
            </li>
            <li className=" tooltip" data-tip="Cooming Soon"><a href="/dashboard/add/admin/post">পোষ্ট করুন</a></li>
            <li className="hover:text-red-600 tooltip" data-tip="Cooming Soon"><a>লগ আউট</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="md:hidden flex gap-6 items-center">
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            <li className="border-b hover:text-green-600 tooltip" data-tip="Cooming Soon">
              <a href="#" className="justify-between">
                প্রোফাইল
                <span className="badge">user</span>
              </a>
            ...
            <li className="border-b hover:text-red-600 tooltip" data-tip="Cooming Soon"><a>লগ আউট</a></li>
          </ul>
        </div>
      </div>
    </div>

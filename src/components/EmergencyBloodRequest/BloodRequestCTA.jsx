  ...
  return (
    <div className="md:col-span-2 mt-6 p-6 bg-white shadow-lg rounded-2xl border-l-4 border-red-500 space-y-6">
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        সমস্ত খরচ আমরা <span className="font-semibold text-red-500">দানকৃত অর্থ থেকে বহন</span> করি। 
        আপনার সাহায্য ছাড়া আমাদের কার্যক্রম চালু রাখা সম্ভব নয়।
      </p>

      <p className="text-gray-700 leading-relaxed">
        তাই আপনার প্রতিটি দান আমাদের এই মহতী কার্যক্রমকে চালু রাখতে সহায়তা করে।
      </p>
